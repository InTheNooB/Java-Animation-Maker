 ...
 * @author dingl01
 */
public class AnimationSet implements Serializable, Constants {
    ...
    public int importAnimation(String animationName) {
        ...
        try {
            ...
            in = new ObjectInputStream(new FileInputStream(new File("bin/animations/" + animationName + "." + ANIMATION_EXTENSION)));
